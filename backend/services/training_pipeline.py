...
class TrainingPipeline:
    ...
    #     print(f"✅ Built Simple Dense model for static features")
    #     return model
    
    # def build_2cnn_model(self, input_shape, num_classes):
    #     """نموذج 2D-CNN للبيانات الثابتة (إطارات مفردة)"""
    ...
    #     print(f"✅ Built 2D-CNN model for static data")
    #     return model
