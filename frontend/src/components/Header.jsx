...
export default function Header() {
  ...
  return (
    <header
      className={`py-4 lg:py-2 w-full mx-auto flex justify-between items-center z-50 transition-all duration-300 ease-in-out max-w-7xl px-8 rounded-full shadow-2xl bg-[#101828]`}
    >
      {/* Logo Section */}
